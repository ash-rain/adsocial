		...
		<div class="col-md-3">
			<div class="market-item tile-block tile-aqua">
				...
				<div class="tile-footer">
					...
					<div class="action">
						<a href="{{ action('HomeController@getAction', [$actions->first()->provider, $actions->first()->post_id, $actionKey]) }}" class="btn btn-green btn-block btn-icon icon-left" title="{{ ucfirst($actionKey) }}">
